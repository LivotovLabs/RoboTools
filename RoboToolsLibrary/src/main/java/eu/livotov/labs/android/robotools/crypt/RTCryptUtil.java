...
public class RTCryptUtil
{
    ...
    @SuppressLint("NewApi")
    public static KeyPair generateRsaPairWithGenerator(Context ctx, String alais) throws InvalidAlgorithmParameterException, NoSuchProviderException, NoSuchAlgorithmException
    {
    ...
    public static String generateDeviceBoundEncryptionKeyForPassword(final Context ctx, String password, boolean lockToWifi, boolean lockToTelephony, boolean lockToSIM)
    {
        StringBuffer finalPassword = new StringBuffer(password);
        finalPassword.append(RTDevice.getDeviceUID(ctx));
