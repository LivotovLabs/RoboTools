    ...
    public void onLocationChanged(Location location) {
        if (location != null && enabledGPSListener) {
            synchronized (this) {
                ...
                boolean sameProvider = (lastProvider != null) && lastProvider.equalsIgnoreCase(location.getProvider());
                ...
                double distanceBetweenLastAndNew = findDistance(lastLat, lastLon, location.getLatitude(), location.getLongitude());
