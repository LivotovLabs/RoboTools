...
public class GoogleMaps {
    ...
    public static boolean initMap(GoogleMap map) {
        return initMap(map, null);
    }

    public static boolean initMap(GoogleMap map, Activity activity) {
    ...
    public static boolean initMapForInlinePreview(GoogleMap map) {
        return initMapForInlinePreview(map, null);
    }

    public static boolean initMapForInlinePreview(GoogleMap map, Activity activity) {
        if (activity != null && !isGoogleMapsAvailable(activity)) {
            return false;
        }
    ...
    public static boolean isSatelliteMode(GoogleMap map) {
        return map != null && map.getMapType() == GoogleMap.MAP_TYPE_SATELLITE;
    }
    ...
    private static boolean checkGmsServiceInstalled(final Context ctx) {
        try {
            return ctx.getPackageManager().getApplicationInfo("com.google.android.gms", 0) != null;
