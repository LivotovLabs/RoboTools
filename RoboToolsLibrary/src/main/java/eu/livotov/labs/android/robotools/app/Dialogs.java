...
public class Dialogs {
    ...
    public static void showConfirmDialog(final Activity ctx, final int icon,
                                       final String title,
    ...
    public static void showConfirmDialog(final Activity ctx, final int icon,
                                       ...
                                       final RTYesNoDialogResultListener listener) {
        showConfirmDialog(ctx, icon, ctx.getString(titleRes),
    ...
    public static class RTInputDialogBuilder {
        ...
        public void build(final RTInputDialogResultListener listener) {
            ...
            alert.show();
            Keyboard.showSoftKeyboardFor(ctx, input);
        }
    }
}
